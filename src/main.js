...
// const greeting = `Welcome ${guestName}, your room nymber is ${roomNumber}!`;
...
// const message = `Username ${username} is ${userLength} characters long`;
// console.log(message);
